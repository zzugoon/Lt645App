...
class Lt645App extends StatefulWidget {
  ...
  @override
  State<Lt645App> createState() => _Lt645Home();
}

class _Lt645Home extends State<Lt645App> with TickerProviderStateMixin<Lt645App> {
...
class RootPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Lotto 6/45 RP Home - ${destination.title}'),
        backgroundColor: destination.color,
      ),
          ...
          children: <Widget>[
            ElevatedButton(
              ...
              onPressed: () {
                ...
                List<dynamic> rsl = genNumber.fn_genNumTypeA("0번이오");
                // ===== "번호 생성하기 end" =====
              },
